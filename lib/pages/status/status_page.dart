      ...
      body: Obx(() {
        return Stack(
          children: [
            ...
            if (loadingController.dataState(Keys.dataFeatureStatusState) ==
                    DataState.loading ||
                loadingController.dataState(Keys.dataFeatureChannelState) ==
                    DataState.loading)
